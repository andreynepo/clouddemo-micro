...
Также создание пользователя и добавление его в группу можно сделать через команды OCI CLI:
...
Вставьте значения OCID пользователя и группы Administrators.

Эти команды приведены для примера. Если вы уже создали пользователя и добавили его в группу, то их выполнять не нужно.
...
Команда предложит путь по умолчанию для сохранения конфигурации. Оставьте его без изменений, нажав **Enter**.
...
Вставьте значение OCID в ответ на запрос.
...
```
Проверить результат этой команды можно:
