...
```bash
$ docker build -t $REGION.ocir.io/$NAMESPACE/clouddemo-micro/front clouddemo-front/docker/ && docker build -t $REGION.ocir.io/$NAMESPACE/clouddemo-micro/api clouddemo-api/docker/ && docker build -t $REGION.ocir.io/$NAMESPACE/clouddemo-micro/db clouddemo-db/docker/ && docker build -t $REGION.ocir.io/$NAMESPACE/clouddemo-micro/wc clouddemo-wc/docker/
```
