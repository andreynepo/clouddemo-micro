...
## !!! FOR SE Only: please include your city and initials into namespace separated by "/". For example, instead of next command, you should use this one: `export NAMESPACE=cloudstarscee/moscow/ane`
...
```bash
$ echo echo "export NAMESPACE=$NAMESPACE" >> $HOME/.bashrc
```
